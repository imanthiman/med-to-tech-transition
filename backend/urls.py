...
from .views import DoctorListCreateView, PatientListCreateView, AppointmentListCreateView, AppointmentListPageView, AppointmentUpdateView, AppointmentDeleteView
